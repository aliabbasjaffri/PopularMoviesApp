...
import com.popularmoviesapp.data.MoviesContract.*;

/**
 * Manages a local database for weather com.popularmoviesapp.data.
 */
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase)
    {
        final String SQL_CREATE_MOVIES_TABLE =
                "CREATE TABLE " + MovieEntry.TABLE_NAME + " (" +
                        ...
                        MovieEntry.COLUMN_USER_POPULARITY + " TEXT NOT NULL " +
